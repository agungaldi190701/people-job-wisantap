                ...
                <div class="card bg-darkblue border-white">
                    <div class="card-body ">
                        <table class="table table-striped table-hover bg-white rounded-2">
                            ...
                            <tbody >
                                @php
                                    $tiket = DB::table('detail_transaksi')->join('destinasis','detail_transaksi.destinasis_id','=','destinasis.id')->where('user_id', Auth::user()->id)->select('detail_transaksi.*','destinasis.nama')->get();
                                @endphp
